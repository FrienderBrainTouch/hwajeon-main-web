        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-12">
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <a
              ...
              className="w-10 h-10 bg-[#2C2E5A] rounded-lg flex items-center justify-center hover:bg-[#3B5998] transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-[#2C2E5A] rounded-lg flex items-center justify-center hover:bg-[#FF0000] transition-colors"
            >
