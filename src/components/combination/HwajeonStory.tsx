  ...
  return (
    <div className="max-w-5xl mx-auto py-8">
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold mb-4">화전 이야기</h2>
      ...
      {/* 마을의 변화와 흐름 섹션 */}
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">마을의 변화와 흐름</h2>
        <h3 className="text-lg text-gray-700 mb-6">
          화전은 지금, 도시와 마을의 경계 위에 서 있습니다
        </h3>

        <div className="bg-gray-200 h-80 rounded-lg flex items-center justify-center mb-8">
          <span className="text-gray-500 text-lg">이미지</span>
        </div>
        ...
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <p>
            ...
            복합적인 마을 구조로 변화했습니다. 도시와 농촌, 개발과 보존, 젊은 세대와 기성세대가 함께
            어우러지는 공간이 되었습니다.
          </p>
          <p>
            화전은 더 이상 낡은 마을이 아닙니다. 변화의 전환점에 선 '플랫폼형 마을'로서, 도시와 삶의
            새로운 가능성을 실험하는 공간으로 나아가고 있습니다.
          </p>
        </div>
      </div>
      ...
      {/* 화전의 정체성 섹션 */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">화전의 정체성</h2>
        <h3 className="text-lg text-gray-700 mb-8">소제목</h3>
