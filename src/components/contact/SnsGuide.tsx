      ...
      <div>
        ...
        <div className="w-full flex flex-col sm:flex-row sm:justify-between gap-4 sm:gap-6">
          ...
          <a
            ...
            className="flex items-center justify-center gap-4 bg-purple-600 hover:bg-purple-700 text-white px-8 sm:px-12 py-4 sm:py-6 rounded-lg transition-colors flex-1"
          >
            <svg
          ...
          >
            ...
            <span className="text-base sm:text-lg font-medium">네이버 블로그</span>
          </a>
        </div>
      </div>
    </div>
