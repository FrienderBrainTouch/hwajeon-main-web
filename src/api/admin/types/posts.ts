 ...
 * @property {string[]} fileUrls - 첨부파일 URL 목록
 */
 ...
 * @property {string} title - 게시글 제목
 * @property {string} content - 게시글 내용
 * @property {ActivityType} [activityType] - 활동 타입 (선택적)
 * @property {number[]} [existingFileIds] - 유지할 기존 파일 ID 목록 (선택적)
 * @property {File[]} [newFiles] - 새로 추가할 파일 목록 (선택적)
 */
